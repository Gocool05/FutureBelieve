...
const Footer = () => {
  return (
<footer className="w-full py-14 BG  bg-purple-900 ">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col justify-center gap-3 items-center max-w-3xl mx-auto">
                <a href="/" className="flex justify-center uppercase text-5xl font-bold text-white">
                <img className='h-16' src="/LOGO.png" alt="" />
                </a>
                    {/* <img className=' h-14 my-1' src="/PlayStore Png.png" alt="Playstore Logo png" /> */}
                    <ul class="text-lg flex items-center justify-center flex-col gap-4 md:flex-row md:gap-4 transition-all duration-500 py-3 mb-1 border-b border-gray-200">
                        <li className="text-white hover:text-purple-300 hover:scale-105 transform duration-200 transition-all" ><a href="#" >About Us</a></li>
                        <li className="text-white hover:text-purple-300 hover:scale-105 transform duration-200 transition-all" ><a href="#" >Terms & Conditions</a></li>
                        <li className="text-white hover:text-purple-300 hover:scale-105 transform duration-200 transition-all" ><a href="#" >Payment and Refund Policy</a></li>
                        <li className="text-white hover:text-purple-300 hover:scale-105 transform duration-200 transition-all" ><a href="#" >Contact Us</a></li>
                    </ul>


                    <div className="flex space-x-10 justify-center items-center my-5">
                        <a href="#" className="block  text-white transition-all duration-300 hover:text-black ">
                    ...
                    <span className="text-lg text-white/65 text-center block">©<a href="/">FutureBelieve</a> 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
  )
