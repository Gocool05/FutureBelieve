...
const Hero = () => {
  return (
    <>
    <div class="flex h-full py-20 justify-center items-center ">
    <div class="text-center max-w-6xl mx-10">
        <p class="my-3 text-sm tracking-widest text-purple-500 uppercase">We Future Believe</p>
     ...
     <section class="relative bg-gradient-to-br from-blue-900 to-purple-800 text-white overflow-hidden">
     <div className="absolute inset-0 bg-black opacity-90"></div>
            <div class="absolute inset-0 bg-cover bg-center opacity-30 rotate-180" style={{backgroundImage:"url(https://wallpapers.com/images/hd/black-and-purple-background-59cafmgzv7dbcv3x.jpg)"}} >
            </div>
            ...
            <div class="container mx-auto px-4 py-24 md:py-32 relative z-10">
                <div class="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="w-full md:w-1/2 mb-12 md:mb-0">
                        {/* <h1 class="text-5xl md:text-6xl font-bold mb-6 leading-tight"> Innovate.<br>Transform.<br>Succeed. </h1> */}
                    ...
                    <div class="w-full md:w-1/2 md:pl-12">
                        <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-xl p-8 shadow-2xl">
                            <h2 class="text-2xl font-semibold mb-6">Why FutureBelieve?</h2>
                            <ul class="space-y-4">
                                ...
                                <li class="flex items-center">
                                    ...
                                    <span>The most effective video branding advertising solution</span>
                                </li>
                                <li class="flex items-center">
    ...
    <div class="flex flex-wrap text-center justify-center">
      <div class="p-4 md:w-1/4 sm:w-1/2">
        <div class="px-4 py-6 transform transition duration-500 hover:scale-110">
          ...
          <h2 class="title-font font-regular text-2xl text-gray-900">Earn Thru Ads</h2>
        </div>
      </div>
