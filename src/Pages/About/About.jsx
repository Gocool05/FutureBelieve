...
const About = () => {
  return (
    ...
    <div className="bg-gray-100 p-8">
      <div className="max-w-full mx-48 bg-white p-8 rounded-lg shadow-md">
        <div className="flex flex-wrap mb-6">
          ...
          <div className="w-full md:w-1/2 md:pr-4">
            <h1 className="text-3xl font-bold mb-6">A Few Words About Us</h1>
        ...
        <div className="flex flex-wrap mb-6">
          ...
          <div className="w-full md:w-1/2 md:pl-4">
            <h2 className="text-2xl font-bold mb-4">The Brand is crowded.</h2>
            <p className="text-lg mb-4">
        ...
        <div className="flex flex-wrap mb-6">
          ...
          <div className="w-full md:w-1/2 md:pr-4">
            <h2 className="text-2xl font-bold mb-4">We focus on engagement.</h2>
            <p className="text-lg mb-4">
