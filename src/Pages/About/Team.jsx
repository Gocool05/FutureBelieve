...
const Team = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <h2 className="mb-4 text-6xl md:text-7xl tracking-tight font-extrabold text-purple-900 ">Our team</h2>
          <p className="font-light text-gray-500 sm:text-xl ">Explore the whole collection of open-source web components and elements built with the utility classNamees from Tailwind</p>
      </div> 
      <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className="text-center text-gray-500 hover:scale-105 transition-all duration-200">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/male.png" alt="Bonnie Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-purple-900 ">
          ...
          <div className="text-center text-gray-500 hover:scale-105 transition-all duration-200 ">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/female.png" alt="Helene Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-purple-900 ">
          ...
          <div className="text-center text-gray-500 hover:scale-105 transition-all duration-200 ">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/male.png" alt="Jese Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-purple-900 ">
                  <a href="#">Jese Leos</a>
              </h3>
              <p>SEO & Marketing</p>
          ...
          <div className="text-center text-gray-500 hover:scale-105 transition-all duration-200 ">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/female.png" alt="Joseph Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-purple-900 ">
          ...
          <div className="text-center text-gray-500 hover:scale-105 transition-all duration-200 ">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/female.png" alt="Sofia Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-purple-900 ">
                  <a href="#">Lana Byrd</a>
              </h3>
              <p>Web Designer</p>
          ...
          <div className="text-center text-gray-500 hover:scale-105 transition-all duration-200 ">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="male.png" alt="Leslie Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-purple-900 ">
          ...
          <div className="text-center text-gray-500 hover:scale-105 transition-all duration-200 ">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/female.png" alt="Michael Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-purple-900 ">
          ...
          <div className="text-center text-gray-500 hover:scale-105 transition-all duration-200 ">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="/male.png" alt="Neil Avatar"/>
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-purple-900 ">
                  <a href="#">Neil Sims</a>
              </h3>
